...
const Booking = () => {
  ...
  return (
    <div className="max-w-[1560px] mx-auto px-4 py-10 sm:px-6 lg:px-8 lg:py-14">

      {/* Card  */}

      <h1 className="text-2xl font-bold px-4 py-10 sm:px-6 lg:px-4 lg:py-4">Booking Information:</h1>
              ...
              >
                <div className="flex justify-between items-center">
                  <span className="text-2xl rounded-md ">
                    <div
                      className={`p-2 rounded ${title === "Clients"
                  ...
                  <span className="rounded-md text-[#5d91eb] -2 flex">
                    <div
                      className={` flex  ${clientPercentage === "+9.18"
                          ? "text-green-500"
                          : clientPercentage === "+183"
                            ? " text-green-500"
                            : clientPercentage === "+6.18"
