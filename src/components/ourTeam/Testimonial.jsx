...
const Testimonial = () => {
    return (
        <div >
               {/* Title */}
        <div className="max-w-2xl mx-auto text-center mb-5 lg:mb-5">
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Testimonials </h2>
      ...
      <div className="overflow-hidden border ">
        <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">
             Loved by business and individuals across the globe </h2>
              ...
              <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
                <div className="flex-auto p-4 md:p-6">
                  <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
                    " With Dewling, we're able to easily track our performance in full detail. It's become an essential tool for us to grow and engage with our audience. "
                  </p>
                </div>
          ...
          <div className="mt-20 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-400">partner with Dewling</p>
            </div>
            {/* End Stats */}
            {/* Stats */}
            <div>
