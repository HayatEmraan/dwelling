...
const teamData = [
  ...
  },
  {
    ...
    Position: "MERN Stack Developer",
    Bio: "Hi there! This is Joyanti Chowdhury. I am a passionate and dedicated MERN Stack DEVELOPER. I am enthusiastic about entering the field and eager to learn and grow in MERN stack development.Always try to grab the new features and technology.",
  ...
  },
  {
    ...
    Position: "Front-end Developer",
    Bio: "'m Md Mehedi Hasan Hridoy, a Front-End Developer. I specialize in creating visually appealing and user-friendly websites. With a passion for design and a knack for coding, I bring ideas to life on the web. When I'm not at my desk, you'll find me exploring the latest trends in web development. I'm committed to learning and love contributing to open-source projects. Let's build something amazing together!",
    ...
    PhotoURL:
      "https://i.ibb.co/pdKqfYq/mehedi.jpg",
  },
]
...
const Team = () => {
    return (
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        {
             teamData.map(({id, Name,Position,Bio,Github,Discord,Portfolio,Linkedin,PhotoURL})=>{
                  ...
                  return(
                    ...
                    <div className="flex items-center gap-x-4">
                      <img className="rounded-full w-20 h-20" src={PhotoURL} alt="Image Description" />
                      <div className="grow">
                   ...
                   {Bio}
                    ...
                    <div className="mt-3 space-x-1">
                      <a className="inline-flex justify-center items-center text-gray-500 border border-gray-200 w-8 h-8 rounded-md hover:text-gray-800 hover:shadow-sm dark:hover:text-gray-200 dark:border-gray-700 dark:hover:shadow-slate-700/[.7]" href={Github}>
                      ...
                      <a className="inline-flex justify-center items-center text-gray-500 border border-gray-200 w-8 h-8 rounded-md hover:text-gray-800 hover:shadow-sm dark:hover:text-gray-200 dark:border-gray-700 dark:hover:shadow-slate-700/[.7]" href={Linkedin}>
                     
                          <FaLinkedin></FaLinkedin>
                      </a>
                      <a className="inline-flex justify-center items-center text-gray-500 border border-gray-200 w-8 h-8 rounded-md hover:text-gray-800 hover:shadow-sm dark:hover:text-gray-200 dark:border-gray-700 dark:hover:shadow-slate-700/[.7]" href={Discord}>
                   
                     
                        <FaDiscord></FaDiscord>
                      </a>
                      <a className="inline-flex justify-center items-center text-gray-500 border border-gray-200 w-8 h-8 rounded-md hover:text-gray-800 hover:shadow-sm dark:hover:text-gray-200 dark:border-gray-700 dark:hover:shadow-slate-700/[.7]" href={Portfolio}>
          ...
          <a className="col-span-full lg:col-span-1 group flex flex-col justify-center text-center rounded-xl p-4 md:p-6 border border-dashed border-gray-200 hover:shadow-sm dark:border-gray-700" 
          href="/contact-team">
