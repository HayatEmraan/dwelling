...
const Footer = () => {
  ...
  return (
      <div className="max-w-[1560px] mx-auto border">
        <footer className="footer p-10 text-base-content">
          <div>
            {/* <img src="/logo.png" alt="" className="w-[50%]"/> */}
            {/* <h3 className="text-2xl text-white m-2 p-2  rounded bg-[#003B95]">Dwelling</h3> */}
          ...
          <div className="mt-16">
            ...
            <button className=" btn btn-primary bg-[#003B95]">Lets Talk With Us</button>
          </div>
        </footer>
      ...
      <div className="items-center flex">
          ...
          <div className="md:place-self-center md:justify-self-end lg:flex">
