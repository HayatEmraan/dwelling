...
const SearchComp = () => {
  ...
  return (
    <div className="border-[1px] w-full md:w-auto py-2 rounded-full mt-2 shadow-sm hover:shadow-md transition"
    onClick={setShowScheduleBar}
    >
      <div className="flex flex-row items-center justify-between">
        <div className="text-sm cursor-pointer font-semibold px-6">Anywhere</div>
        <div className="hidden cursor-pointer sm:block text-sm font-semibold px-6 border-x-[1px] flex-1 text-center">
          Any Week
        </div>
