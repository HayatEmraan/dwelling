...
const Setting = () => {
  ...
  useEffect(() => {
    ...
    const newImageUrls = [];
    selectedImages.map(selectedImage => newImageUrls.push(URL.createObjectURL(selectedImage)))
  ...
  e.preventDefault()
   ...
   console.log(image1);
    ...
    return (
      ...
      <label
        htmlFor="photoInput"
        className="rounded-xl px-4 py-2 cursor-pointer transition"
      >
        ...
        <svg
          ...
          Upload Photo</span>
                  ...
                  {/* <button    id="imageUpload"   
                   accept="image/*"
                    type="button"
                    className="bg-[#003B95] inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                  >
          ...
          <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            <div className="flow-root">
                ...
                <li className="py-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="inline-flex items-center">
                      <a
                        href="#"
                        className=" bg-[#003B95] px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                      >
                        Connect
                      </a>
                    </div>
              ...
              <div>
                <button className="  bg-[#003B95]  text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                  Save all
                </button>
              </div>
            </div>
