...
import PropertyModal from "../propertyPage/PropertyModal";
import { BsViewList } from "react-icons/bs";
import { getproperties } from "@/utils/async/admin/properties/getproperties";

const DashProperty = async () => {
  const pageData = await getproperties();
  return (
                ...
                <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                        ...
                        >
                          ...
                          >
                            <div className="divide-y divide-gray-200 dark:divide-gray-700">
                              ...
                              >
                                <button className="ml-3 text-sm text-gray-800 dark:text-gray-200">
                                  Approved
                                </button>
                              </label>
                              <label
                  ...
                  <table className="p-2 min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                      {pageData?.data?.slice(0, 5).map((item, index) => (
                        <tr key={index}>
