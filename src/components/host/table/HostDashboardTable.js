...
const HostDashboardTable = () => {
  return (
    <div className="max-w-[150rem] mx-auto px-4 py-10 sm:px-6 lg:px-16 mt-12 lg:py-4 text-black dark:text-gray-200">
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <tr>
                    ...
                    <td className="h-px w-px whitespace-nowrap">Trnx Number</td>
...
export default HostDashboardTable;
